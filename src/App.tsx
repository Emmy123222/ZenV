...
function App() {
  ...
  const [seedPhrase] = useState(['apple', 'banana', 'cherry', 'date', 'elder', 'fig', 'grape', 'honey', 'ice', 'jam', 'kiwi', 'lemon']);
  ...
  const screens: Record<Screen, JSX.Element> = {
    ...
    seedphrase: <Seedphrase setCurrentScreen={setCurrentScreen} seedPhrase={seedPhrase} />,
    home: <Home 
    ...
    />,
    transactions: <Transactions currentScreen={currentScreen} setCurrentScreen={setCurrentScreen} />,
    vault: <Vault currentScreen={currentScreen} setCurrentScreen={setCurrentScreen} />
  };
