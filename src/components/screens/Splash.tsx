...
export function Splash({ setCurrentScreen }: SplashProps) {
  return (
    <div 
      className="min-h-screen relative flex flex-col items-center justify-center text-white text-center p-6"
      style={{
        backgroundImage: 'url("https://images.unsplash.com/photo-1622630998477-20aa696ecb05?auto=format&fit=crop&w=1920&h=1080")',
    ...
    >
      ...
      >
        <h1 className="text-3xl font-bold mb-4">Welcome To CryptoVault</h1>
        <p className="text-lg mb-12 text-gray-200">Your secure fortress for digital assets</p>
        <button
